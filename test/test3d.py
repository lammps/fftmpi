...
def timing():
  ...
  if me == 0:
    ...
    print "  x pencil proc grid: %d %d %d" % \
      (fft.get("npfast1",1,0),fft.get("npfast2",1,0),fft.get("npfast3",1,0))
    print "  y pencil proc grid: %d %d %d" % \
       (fft.get("npmid1",1,0),fft.get("npmid2",1,0),fft.get("npmid3",1,0))
    print "  z pencil proc grid: %d %d %d" % \
       (fft.get("npslow1",1,0),fft.get("npslow2",1,0),fft.get("npslow3",1,0))
    print "  2d brick proc grid: %d %d %d" % \
       (fft.get("npbrick1",1,0),fft.get("npbrick2",1,0),fft.get("npbrick3",1,0))
      ...
      for i in range(ntrial):
        print "  coll exch pack 3dFFT 1dFFT remap r1 r2 r3 r4: " + \
          ...
          (fft.get("cflags",1,1)[i],fft.get("eflags",1,1)[i],
           ...
           fft.get("tremap3",2,1)[i],fft.get("tremap4",2,1)[i])
