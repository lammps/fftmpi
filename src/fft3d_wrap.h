...
void fft3d_create_fortran(MPI_Fint, int, void **);
...
char *fft3d_get_string(void *, const char *, int *);
int *fft3d_get_int_vector(void *, const char *, int *);
double *fft3d_get_double_vector(void *, const char *, int *);
